...
Requires Node.js 18 or later. Run `nexus --help` and `nexus <command> --help` for the exact syntax of the version you have installed. A fuller reference lives in [`wiki/CLI.md`](../wiki/Home.md).
